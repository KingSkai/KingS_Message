...
class AppDelegate: UIResponder, UIApplicationDelegate,RCIMUserInfoDataSource {
    ...
    func getUserInfo(withUserId userId: String!, completion: ((RCUserInfo?) -> Void)!) {
        ...
        userInfo.name = Common.sharedInstance.user
        ...
        print("portriat:", Common.sharedInstance.portriat)
        guard Common.sharedInstance.portriat == nil else {
            userInfo.portraitUri = Common.sharedInstance.portriat
            return
        }
