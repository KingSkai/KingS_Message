...
//    var possibleInputs : Inputs = []
    ...
    @IBAction func actionLog(_ sender: Any) {
        ...
        query.getFirstObjectInBackground { (object, err) in
            ...
            if object != nil {
                //https://dn-nahcolcq.qbox.me/DF5kZzEahHimZRGy6WZsJZB
                Common.sharedInstance.user = object?.object(forKey: "user") as! String!
                Common.sharedInstance.mail = object?.object(forKey: "mail") as! String!
                Common.sharedInstance.objectId = object?.object(forKey: "objectId") as! String!
                let dic = object?.object(forKey: "portriat")
                let file:AVFile = dic as! AVFile
                Common.sharedInstance.portriat = file.url!
