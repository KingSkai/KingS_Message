...
class RegTableViewController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(RegTableViewController.alterOut))
    ...
    @IBAction func doneAction(_ sender: UIBarButtonItem) {
        ...
        user.setObject(file, forKey: "portriat")
    ...
    func alterOut() {
        ...
        let alter = UIAlertController(title: "请选择相机或相册", message: nil, preferredStyle: .actionSheet)
        let alterAction_1 = UIAlertAction(title: "相机", style: .default) { (UIAlertAction) in
            self.camera()
        }
        let alterAction_2 = UIAlertAction(title: "相册", style: .default) { (UIAlertAction) in
            self.photo()
        }
        let alterAction = UIAlertAction(title: "取消", style: .cancel, handler: nil)
        alter.addAction(alterAction)
        alter.addAction(alterAction_1)
        alter.addAction(alterAction_2)
